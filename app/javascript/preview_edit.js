  ...
  //プレビュー機能
    ...
    if ( document.getElementById('diary_edit_form')){
      ...
      const createImageHTML = (blob) => {
        ...
        // 生成したdiv要素にclass名を付与
        imageElement.setAttribute('class', "image-element preview_element")
        // 何個目のimage-elementクラス(プレビュー表示版)のdiv要素か定義
        let imageElementNum = `${document.querySelectorAll('.preview_element').length + 1}`
        // 画像を表示するためのimg要素を生成
        ...
        const firstInput = document.getElementById('diary_image_0')
      ...
      document.querySelector(".first_button").addEventListener('change', function(e){
